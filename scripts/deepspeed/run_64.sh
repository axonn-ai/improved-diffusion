...
cmd="srun -N ${NNODES} -n ${GPUS} python scripts/image_train.py $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS --deepspeed_config ./scripts/deepspeed/ds_config_64.json | tee ${OUTFILE}"
