...
# divided batch size (2048) by num gpus (1024) to get 2 batch size
# changed num_channels to 1600 to get a model size of roughly 8 bil
# changed learning rate according to paper: (1 / ((1600 / 128) ^ 0.5)) * 0.0001 = 0.00002828427
